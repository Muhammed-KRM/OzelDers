...
Bu doküman, projede oluşturulacak Blazor Web arayüzünün (UI) genel ruhunu, estetiğini ve kullanılacak ana görsel kuralları belirler. "Özel Ders" kavramının barındırdığı **"Güven/Disiplin"** ve **"Gelişim/Heyecan"** duygularını dengeli bir şekilde yansıtmak üzerine tasarlanmıştır.
...
---
**Özet:** Keskin olmayan, 3D materyal ikonlarla desteklenmiş, arka planların ferah olduğu, Gece Mavisi ile güven verip Canlı Mercan kırmızılarıyla kullanıcıyı harekete geçiren "Apple/Modern Startup" pürüzsüzlüğünde bir tasarım inşa edeceğiz.
